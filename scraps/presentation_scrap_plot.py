...
timestmaps = np.load("/mnt/data/teamAI/duy/deep_ekf_vio/results/iterated_saved3/saved_model.eval.traj/timestamps/K07.npy")
gt_velocities = np.load(
    os.path.join("/mnt/data/teamAI/duy/deep_ekf_vio/results/iterated_saved3/saved_model.eval.traj/ekf_states/gt_velocities", seq + ".npy"))
est_velocities = np.load(
    os.path.join("/mnt/data/teamAI/duy/deep_ekf_vio/results/iterated_saved3/saved_model.eval.traj/ekf_states/states", seq + ".npy"))[:,
                 15:18]
...
# vis_meas = np.load("/home/cs4li/Dev/deep_ekf_vio/results/train_20200130-22-45-48/saved_model.eval.traj/vis_meas/meas/K07.npy")
vis_meas2 = np.load("/mnt/data/teamAI/duy/deep_ekf_vio/results/iterated_saved3/saved_model.eval.traj//vis_meas/meas/K07.npy")
