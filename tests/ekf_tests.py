...
class Test_EKF(unittest.TestCase):
    ...
    def plot_ekf_data(self, output_dir, timestamps, gt_poses, gt_vels, est_poses, est_states):
        ...
        for i in range(0, len(est_poses)):
            ...
            g, _, _, v, bw, ba = IMUKalmanFilter.decode_state(torch.tensor(est_states[i]))
